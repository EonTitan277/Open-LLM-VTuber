...
**🪧 個人フォークに関するお知らせ**：これは、私自身の使用のためにメンテナンスされている[Open-LLM-VTuber](https://github.com/Open-LLM-VTuber/Open-LLM-VTuber)の個人フォークです。私個人にとって有益な追加機能や修正が含まれています。私はこのフォークを積極的にメンテナンスしておらず、アップストリームとの同期も行っておりません。すべての新しいコードおよび変更は、[Claude](https://claude.ai/) によって生成されたものです。
